"""
Jewish_Django settings for Jewish_Django project.

Generated by 'django-admin startproject' using Jewish_Django 4.1.6.
...
ROOT_URLCONF = "Jewish_Django.urls"
...
WSGI_APPLICATION = "Jewish_Django.wsgi.application"
...
AUTH_USER_MODEL = 'Jewish_Django.User'
