...
urlpatterns = [
    ...
    path('get_pending_requests/',get_pending_requests_to_community_view, name='get_pending_requests_to_community_view'),#specified community
    path('get_pending_invites/',get_pending_invites_to_community_view, name='get_pending_invites_to_community_view'),#specified community
    path('get_users_pending_invites_communities/',get_users_pending_invites_to_community_view, name='get_users_pending_invites_to_community_view'),#specified user
