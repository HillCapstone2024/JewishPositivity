...
urlpatterns = [
    ...
    path('get_users_in_community/',get_users_in_community_view, name='get_users_in_community_view') # #Gets users that are successfully in a community (status of 2)
]
