...
urlpatterns = [
    ...
    #path('current_streak_view/',current_streak_view, name='current_streak_view'),
    #path('longest_streak_view/',longest_streak_view, name='longest_streak_view')
]
