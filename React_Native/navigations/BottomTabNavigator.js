      ...
      screenOptions={{
          ...
          options={{
            tabBarIcon: ({ focused }) => (
              <View style={{position: 'absolute',top: 15,}}>
                <Ionicons name="home" size={25} color={focused ? '#4A90E2' : 'gray'} />
              </View>),
          }}
        ...
        <Tab.Screen name="Journal" component={JournalEntry}
          options={{
            tabBarIcon: ({ focused }) => (
              ...
              <View style={{position: 'absolute',top: 15,}}>
                <Ionicons name="journal" size={25} color={focused ? '#4A90E2' : 'gray'} />
              </View>),
          }}
          listeners={({ navigation, route }) => ({
            // Onpress Update....
        ...
        <Tab.Screen name="Archive" component={Archive}
          options={{
            tabBarIcon: ({ focused }) => (
              <View style={{position: 'absolute',top: 15,}}>
                <Ionicons name="archive" size={25} color={focused ? '#4A90E2' : 'gray'} />
              </View>),
          }}
          listeners={({ navigation, route }) => ({
            // Onpress Update....
